  ...
  if (sorted.length === 0) {
    return (
      <div className="rounded-2xl bg-card border border-border p-6 text-center">
        <p className="text-muted-foreground text-sm">No savings yet. Start adding to your goals!</p>
      </div>
    );
  }
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate">{goal?.name || "Deleted goal"}</p>
